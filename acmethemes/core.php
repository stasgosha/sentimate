...
function corporate_plus_scripts() {
	...
	global $wp_query; 
	wp_localize_script( 'corporate-plus-custom', 'loadmore_params', array(
 ...
 * check if edit page
 */
function corporate_plus_is_edit_page() {
...
function corporate_plus_admin_scripts( $hook ) {
	if ( 'widgets.php' == $hook || corporate_plus_is_edit_page() ){
		wp_enqueue_media();
...
// function revuzeapi_scripts() {

//     if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
//         wp_enqueue_script( 'comment-reply' );
//     }
//     if (get_page_template_slug() == 'product_template.php') {
//         wp_enqueue_script('amcharts-core', 'https://cdn.amcharts.com/lib/4/core.js', array('jquery'), '1.1.1', 1);
//         wp_enqueue_script('amcharts-charts', 'https://cdn.amcharts.com/lib/4/charts.js', array('jquery'), '1.1.1', 1);
//         wp_enqueue_script('amcharts-animated', 'https://cdn.amcharts.com/lib/4/themes/animated.js', array('jquery'), '1.1.1', 1);
//         wp_enqueue_script('product-template', get_template_directory_uri() . '/Revuze/js/product_template.js', array('jquery'), '1.1.1', 1);


//     }
//     if (get_page_template_slug() == 'product_compare.php') {
//         wp_enqueue_script('amcharts-core', 'https://cdn.amcharts.com/lib/4/core.js', array('jquery'), '1.1.1', 1);
//         wp_enqueue_script('amcharts-charts', 'https://cdn.amcharts.com/lib/4/charts.js', array('jquery'), '1.1.1', 1);
//         wp_enqueue_script('amcharts-animated', 'https://cdn.amcharts.com/lib/4/themes/animated.js', array('jquery'), '1.1.1', 1);
//         wp_enqueue_script('product-compare', get_template_directory_uri() . '/Revuze/js/product_compare.js', array('jquery'), '1.1.1', 1);
//     }

//     if (get_page_template_slug() == 'product_search.php') {
//         wp_enqueue_script('product-search', get_template_directory_uri() . '/Revuze/js/product_search.js', array('jquery'), '1.1.1', 1);
//     }
//     wp_localize_script( 'product-template', 'myajax', array(
//         'url' => admin_url( 'admin-ajax.php' ), // WordPress AJAX
//     ) );
//     // wp_enqueue_style( 'revuze-api', get_template_directory_uri() . '/assets/css/revuze-new.css', array(), '1.0.0' );
//     // wp_enqueue_style( 'revuze-api-custom', get_template_directory_uri() . '/Revuze/css/custom.css', array(), '1.0.0' );
// }
// add_action( 'wp_enqueue_scripts', 'revuzeapi_scripts' );