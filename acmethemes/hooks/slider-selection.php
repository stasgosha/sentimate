                    ...
                    <li class="clearfix">
                        <div class="at-overlay">
                            <div class="container text-slider-wrapper">
                                <span class="lead banner-title init-animate fadeInRight"><?php _e('<h1><b>Big Data</b><br>Consumer Analytics</h1>','corporate-plus' );?></span>
                                ...
                                <div class="text-slider-caption init-animate fadeInDown">
		                            <?php _e('<img src="/wp-content/uploads/2018/09/nielsen-1.png" alt="A Nielsen Company" width="248" height="38">','corporate-plus' );?>
                                </div>
                                <a href="https://www.revuze.it/demo" class="fadeInUp btn btn-primary outline-outward banner-btn">
		                            <?php _e('DEMO','corporate-plus'); ?>
                                </a>
                            </div>
                        </div>
					</li>
