...
<div class="mg__item" id="product_monthly_reviews" data-info='<?php echo json_encode($product_monthly_reviews);?>'>
    <div class="mg__title">
        ...
        <a href="https://pro.sentimate.com/"  class="v_all"><?php echo get_field('customer_satisfaction_btn','option');?> <img src="<?= $baseAssetUrl; ?>img/icons/arrow_pp.svg" alt="arrow"></a>
    </div>
