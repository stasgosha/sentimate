...
<div class="mg__item mg__item__lg">
    <div class="mg__title">
        ...
        <a href="https://pro.sentimate.com/"  class="v_all"><?php echo get_field('customer_satisfaction_big_grafbtn','option');?><img src="<?= $baseAssetUrl; ?>img/icons/arrow_pp.svg" alt="arrow"></a>
    </div>
